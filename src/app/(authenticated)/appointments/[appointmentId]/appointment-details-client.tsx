...
import { AppointmentDetailsProps, State, Action, Appointment, AppointmentStatus } from "./types";
...
export default function AppointmentDetailsClient({ 
  ...
  const handleAddParticipant = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/embeddings/appointments/${appointment.id}/participants`,
        {
          method: "POST",
          headers: {
  ...
  const handleStatusChange = async (newStatus: AppointmentStatus) => {
    ...
    try {
      const endpoint = {
        completed: `${process.env.NEXT_PUBLIC_API_URL}/embeddings/appointments/${appointment.id}/complete`,
        canceled: `${process.env.NEXT_PUBLIC_API_URL}/embeddings/appointments/${appointment.id}/cancel`,
        upcoming: `${process.env.NEXT_PUBLIC_API_URL}/embeddings/appointments/${appointment.id}`,
        pending: `${process.env.NEXT_PUBLIC_API_URL}/embeddings/appointments/${appointment.id}`,
      }[newStatus];
              ...
              <DialogContent className="sm:max-w-[425px]">
                <form onSubmit={handleAddParticipant}>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Add a new participant to this appointment. They will
