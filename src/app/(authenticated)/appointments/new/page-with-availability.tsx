...
//         <div className="bg-blue-50 rounded-lg shadow p-6 md:w-1/3">
...
//                 participants' email addresses and check their availability.
//               </p>
//               <div className="mt-4 p-3 bg-white rounded border border-blue-200">
//                 <h4 className="text-sm font-medium text-blue-800 mb-2">New Feature!</h4>
//                 <p className="text-xs text-blue-600">
//                   You can now check for participant scheduling conflicts before creating an appointment. 
//                   This helps ensure everyone is available for your meeting.
//                 </p>
//               </div>
//             </div>
//           </div>
